...

{
	...
	/** Create a border index array of boundary points of the mask with radius-neighbors
	  ...
	  */
	createBorderForBlur(mask, radius, visited) {
		var x, i, j, y, k, k1, k2,
			w = mask.width,
			h = mask.height,
			data = mask.data,
	...
	/** Simplify contours
	  ...
	  */
	simplifyContours(contours, simplifyTolerant, simplifyCount) {
